...
export class StackedBarChartComponent implements OnInit {
  public data: any[] = [
    { category: "KW 40", value1: 30, value2: 8, value3: 0 },
    { category: "KW 41", value1: 15, value2: 25, value3: 0 },
    { category: "KW 42", value1: 20, value2: 30, value3: 0 },
    { category: "KW 43", value1: 20, value2: 30, value3: 0 },
    { category: "KW 44", value1: 20, value2: 30, value3: 0 },
  ];
  ...
  createChart() {
    ...
    const y = d3
      ...
      .domain([
        0,
        d3.max(series, (d) => d3.max(d, (d) => d[1])) as number
      ])
      .range([this.height, 0]);
